...
! 1 => The 3 parameters in the splice method are(in order)
    ...
    - The elements to add to the array, starting at the index specified in the first parameter

! 2 => This is saying that we will target index 4, remove one element("June") and then replace it with "May"
